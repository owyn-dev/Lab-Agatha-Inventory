      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              <label class="form-label">Quantity Production</label>
              <input class="form-control" type="text" wire:model="quantity_production" min="1">
            </div>
            <div class="mb-3">
              <label class="form-label">Shelf Name</label>
              <input class="form-control" type="text" wire:model="shelf_name">
            </div>
          </div>
          <div class="modal-footer">
            ...
            if (selectedProduct) {
                isLoading = true;
                await $wire.addProduct(selectedProduct.id, $wire.quantity_production, $wire.shelf_name);
                isLoading = false;
